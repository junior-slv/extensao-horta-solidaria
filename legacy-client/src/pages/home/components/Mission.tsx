...
const Mission: React.FC = () => {
  return (
    <section className="grid grid-cols-1 bg-green-100 p-5 md:grid-cols-2 md:p-20">
      <div className="mx-auto w-full py-8 text-center sm:py-16 md:px-8 lg:px-6">
        <h2 className="mb-4 text-xl font-bold tracking-tight text-gray-900 md:text-3xl">
          Projeto Horta Solidária
        </h2>
        <p className="text-sm font-thin text-gray-600 md:text-xl">
